...
<%@include file="header.jsp" %>
        <form action="<%=request.getContextPath()%>/validerInscriptionServlet" method="post">
            <div class="panel-heading success">INFO-PERSONNEL</div>
                <div class="panel-body">
                    ...
                    <div class="form-group">
                     ...
                     <div class="large-3 columns">
                        ...
                        <input type="radio" name="Sexe" value="M" id="M"/><label for="M">Masculin</label>
                        <input type="radio" name="Sexe" value="F" id="F"/><label for="F">Feminin</label>
                      </div>
